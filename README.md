...
* Enable automated dependapbot security updates under Settings > Security & Analysis. Then install the [automerge app](https://github.com/apps/dependabot-merge-action) in your organization if you're not part of the `byu-oit` organization.
